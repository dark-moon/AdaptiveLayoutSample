...
//        String[] args = {PRODUCT_COLUMN_NAME  + " = " + product.getName()};
//        String productName = null;
//        Cursor cursor = db.rawQuery("SELECT " + PRODUCT_COLUMN_NAME + " FROM " + PRODUCT_TABLE_NAME + " WHERE " +
//                PRODUCT_COLUMN_NAME  + " = '" + product.getName() + "'", null);
...
//
//        if (productName != null){
//            updateProduct(new Product(productName, ""), product);
//        } else {
//            insetProduct(product);
//        }
//    }
//
